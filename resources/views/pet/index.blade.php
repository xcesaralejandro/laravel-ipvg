...
<div class="container py-5">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-5 gap-3">
        ...
        <a href="#" class="btn btn-primary shadow-sm fw-bold btn-subtle-hover btn-add-hover"
    ...
    <div class="row g-4">
        <div class="col-12 col-lg-6 col-xl-4">
            <div class="card border-0 shadow-sm h-100" style="border-radius: 20px; background: #ffffff;">
                ...
                <div class="card-body pt-0 px-4 pb-4">
                    <div class="mb-3">
                        <h4 class="fw-bold mb-1">Firulais</h4>
                        <p class="text-muted small mb-0">Golden Retriever • 3 años</p>
                    </div>

                    <div class="d-flex gap-3 mb-4">
                        <div class="small text-secondary">
                            <strong class="text-dark">Peso:</strong> 12kg
                        </div>
                        <div class="small text-secondary">
                            <strong class="text-dark">Color:</strong> Canela
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <button class="btn btn-light d-flex align-items-center justify-content-center btn-subtle-hover btn-delete-hover"
                           title="Eliminar" style="width: 40px; height: 40px; border-radius: 10px; background-color: #fee2e2; color: #dc3545;">
                           <small>🗑️</small>
                        </button>
                    </div>
                </div>
        ...
        <div class="col-12 col-lg-6 col-xl-4">
            <div class="card border-0 shadow-sm h-100" style="border-radius: 20px; background: #ffffff;">
                <div class="p-3">
                    <div class="d-flex align-items-center justify-content-center"
                         style="height: 150px; background-color: #fdf2f8; border-radius: 15px; position: relative;">
                        <span style="font-size: 3.5rem;">🐱</span>
                        <span class="badge position-absolute top-0 start-0 m-2 border-0"
                              style="background-color: #1e7e34; font-size: 0.7rem; border-radius: 8px;">
                            FELINO
                ...
                <div class="card-body pt-0 px-4 pb-4">
                    <div class="mb-3">
                        <h4 class="fw-bold mb-1">Michi</h4>
                        <p class="text-muted small mb-0">Siames • 1 año</p>
                    </div>
                    <div class="d-flex gap-3 mb-4">
                        <div class="small text-secondary"><strong class="text-dark">Peso:</strong> 4kg</div>
                        <div class="small text-secondary"><strong class="text-dark">Color:</strong> Gris</div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <a href="#" class="btn btn-light flex-grow-1 fw-bold btn-subtle-hover btn-ficha-hover"
                           style="background-color: #f8f9fa; color: #1e7e34; border-radius: 10px; font-size: 0.9rem; padding: 10px;">
