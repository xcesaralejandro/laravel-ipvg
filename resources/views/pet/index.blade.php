...
@section('content')
    <div class="container py-5">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-5 gap-3">
            ...
            <a href="{{ route('pets.create') }}" class="btn btn-primary btn-sm px-3">
                    ...
                    <div class="card border-0 shadow-sm h-100" style="border-radius: 20px; background: #ffffff;">
                        <div class="p-3">
                            <div class="d-flex align-items-center justify-content-center"
                                ...
                                <span style="font-size: 3.5rem;">{{ $pet->photo }}</span>
                        ...
                        <div class="card-body pt-0 px-4 pb-4">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <a href="{{ route('medical-visits.index', ['pet_id' => $pet->id]) }}"
                                    class="btn btn-light flex-grow-1 fw-bold btn-subtle-hover btn-ficha-hover"
                                    style="background-color: #f8f9fa; color: #1e7e34; border-radius: 10px; font-size: 0.9rem; padding: 10px;">
                                    Ver Ficha
                                </a>

                                <a href="{{ route('pets.edit', $pet->id) }}"
                                    class="btn btn-light d-flex align-items-center justify-content-center btn-subtle-hover btn-edit-hover"
                                    title="Editar"
                                    style="width: 40px; height: 40px; border-radius: 10px; background-color: #e9ecef; color: #495057;">
                                    <small>✏️</small>
                                </a>
