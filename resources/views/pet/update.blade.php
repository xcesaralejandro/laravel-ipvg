                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="name" value="{{ old('name', $pet->name) }}"
                                    class="form-control bg-light border-0 py-2" placeholder="Ej: Halsey" />
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Especie</label>
                                <input type="text" name="species" value="{{ old('species', $pet->species) }}"
                                    class="form-control bg-light border-0 py-2" placeholder="Canino, felino..." />
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Nacimiento</label>
                                <input type="date" name="birth_date" value="{{ old('birth_date', $pet->birth_date) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="weight" step="0.1"
                                    value="{{ old('weight', $pet->weight) }}" class="form-control bg-light border-0 py-2"
                                    placeholder="0.0" />
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="color" value="{{ old('color', $pet->color) }}"
                                    class="form-control bg-light border-0 py-2" placeholder="Ej: Café" />
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Foto (URL)</label>
                                <input type="text" name="photo" value="{{ old('photo', $pet->photo) }}"
                                    class="form-control bg-light border-0 py-2" placeholder="http://..." />
                            </div>
